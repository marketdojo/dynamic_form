...
class DynamicFormTest < ActionView::TestCase
  ...
  def test_form_with_action_option
    ...
    assert_select 'form[action=sign]' do |_form|
  ...
  def test_error_for_block
    ...
    assert_equal %(<div class="errorDeathByClass" id="errorDeathById"><h1>1 error prohibited this post from being saved</h1><p>There were problems with the following fields:</p><ul><li>Author name can't be empty</li></ul></div>),
                 error_messages_for('post', class: 'errorDeathByClass', id: 'errorDeathById', header_tag: 'h1')
    assert_equal %(<div id="errorDeathById"><h1>1 error prohibited this post from being saved</h1><p>There were problems with the following fields:</p><ul><li>Author name can't be empty</li></ul></div>),
                 error_messages_for('post', class: nil, id: 'errorDeathById', header_tag: 'h1')
    assert_equal %(<div class="errorDeathByClass"><h1>1 error prohibited this post from being saved</h1><p>There were problems with the following fields:</p><ul><li>Author name can't be empty</li></ul></div>),
  ...
  def test_error_messages_for_escapes_html
    ...
    assert_dom_equal %(<div class="errorExplanation" id="errorExplanation"><h2>1 error prohibited this dirty post from being saved</h2><p>There were problems with the following fields:</p><ul><li>Author name can't be &lt;em&gt;empty&lt;/em&gt;</li></ul></div>),
  ...
  def test_error_message_on_escapes_html
    @dirty_post = DirtyPost.new
    assert_dom_equal "<div class=\"formError\">can't be &lt;em&gt;empty&lt;/em&gt;</div>",
  ...
  def test_error_message_on_with_options_hash
    assert_dom_equal "<div class=\"differentError\">beforecan't be emptyafter</div>",
                     error_message_on(:post, :author_name, css_class: 'differentError', prepend_text: 'before',
                                                           append_text: 'after')
  end

  def test_error_message_on_with_tag_option_in_options_hash
    assert_dom_equal "<span class=\"differentError\">beforecan't be emptyafter</span>",
                     error_message_on(:post, :author_name, html_tag: 'span', css_class: 'differentError', prepend_text: 'before',
                                                           append_text: 'after')
  end
  ...
  def test_error_messages_for_many_objects
    assert_dom_equal %(<div class="errorExplanation" id="errorExplanation"><h2>2 errors prohibited this post from being saved</h2><p>There were problems with the following fields:</p><ul><li>Author name can't be empty</li><li>User email can't be empty</li></ul></div>),
    ...
    assert_dom_equal %(<div class="errorExplanation" id="errorExplanation"><h2>2 errors prohibited this post from being saved</h2><p>There were problems with the following fields:</p><ul><li>User email can't be empty</li><li>Author name can't be empty</li></ul></div>),
    ...
    assert_dom_equal %(<div class="errorExplanation" id="errorExplanation"><h2>2 errors prohibited this monkey from being saved</h2><p>There were problems with the following fields:</p><ul><li>User email can't be empty</li><li>Author name can't be empty</li></ul></div>),
                     error_messages_for(:user, :post, object_name: 'monkey')

    # should space object name
    assert_dom_equal %(<div class="errorExplanation" id="errorExplanation"><h2>2 errors prohibited this chunky bacon from being saved</h2><p>There were problems with the following fields:</p><ul><li>User email can't be empty</li><li>Author name can't be empty</li></ul></div>),
                     error_messages_for(:user, :post, object_name: 'chunky_bacon')

    # hide header and explanation messages with nil or empty string
    assert_dom_equal %(<div class="errorExplanation" id="errorExplanation"><ul><li>User email can't be empty</li><li>Author name can't be empty</li></ul></div>),
    ...
    assert_dom_equal %(<div class="errorExplanation" id="errorExplanation"><h2>#{header_message}</h2><p>#{message}</p><ul><li>User email can't be empty</li><li>Author name can't be empty</li></ul></div>),
